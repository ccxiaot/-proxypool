...
<p align="center">
  <a href="https://github.com/ccxiaot/-proxypool/actions">
    <img src="https://img.shields.io/github/workflow/status/zu1k/proxypool/Go?style=flat-square" alt="Github Actions">
  </a>
  <a href="https://goreportcard.com/report/github.com/ccxiaot/-proxypool">
    <img src="https://goreportcard.com/badge/github.com/ccxiaot/-proxypool?style=flat-square">
  </a>
  <a href="https://github.com/ccxiaot/-proxypool/releases">
...
```sh
$ go get -u -v github.com/ccxiaot/-proxypool
```

### 下载预编译程序

从这里下载预编译好的程序 [release](https://github.com/ccxiaot/-proxypool/releases)

### 使用docker

```sh
docker pull docker.pkg.github.com/ccxiaot/-proxypool/proxypool:latest
```
